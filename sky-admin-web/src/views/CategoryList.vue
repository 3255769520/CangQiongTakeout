<template>
  <el-card>
    <div style="margin-bottom: 20px; display: flex; gap: 10px;">
      <el-input v-model="queryParams.name" placeholder="分类名称" style="width: 220px" clearable />
    ...
    <el-dialog v-model="dialogVisible" :title="formType === 'add' ? '新增分类' : '修改分类'" width="420px">
